...
namespace XRCardboard
{
    public class XRCardboardInputModule : PointerInputModule
    {
        ...
        [SerializeField] UnityFloatEvent onStartHover = default;
        [SerializeField] UnityEvent onEndHover = default;
        [SerializeField] UnityEvent onClick = default;
        ...
        void HandleSelection()
        {
            ...
            if (Time.realtimeSinceStartup > currentTargetClickTime || 
                settings.AnyClick && Input.anyKeyDown ||
                Input.GetButtonDown(settings.ClickInput))
            {
